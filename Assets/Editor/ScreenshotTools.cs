...
public class ScreenshotTools
{
    ...
    public static void CaptureScreenshot()
    {
        ...
        // ローカルフォルダ内のスクリーンショットフォルダにスクリーンショットのフォルダを作成
        string directory = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory), "ScreenShot", productName);

        // string directory = Path.Combine("r'\\192.168.250.47\\mobile7\\98.ハイパーカジュアル\\02_ゲーム\\99_スクショ\\ScreenShot", productName);
